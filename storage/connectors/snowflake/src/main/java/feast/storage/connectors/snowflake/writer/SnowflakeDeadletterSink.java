...
public class SnowflakeDeadletterSink implements DeadletterSink {

  private static final String DEADLETTER_SCHEMA_FILE_PATH = "schemas/deadletter_table_schema.json";
  private static final Logger log =
      org.slf4j.LoggerFactory.getLogger(SnowflakeDeadletterSink.class);
  private static final String TIMESTAMP_COLUMN = "timestamp";

  private final String tableSpec;
  private String jsonSchema;

  public SnowflakeDeadletterSink(String tableSpec) {
  ...
  public abstract static class WriteFailedElement
    ...
    public static Builder newBuilder() {
      return new AutoValue_SnowflakeDeadletterSink_WriteFailedElement.Builder();
    }
  ...
  public static class FailedElementToTableRowFn extends DoFn<FailedElement, Void> {
    @ProcessElement
